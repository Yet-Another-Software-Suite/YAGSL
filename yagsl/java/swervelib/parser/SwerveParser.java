...
public class SwerveParser {
  ...
  /**
   * Parses the given directory and returns a {@link SwerveParser} containing the
   * parsed configuration.
   *
   *
   * @param directory the directory containing the Swerve configuration
   * @return the {@link SwerveParser} containing the parsed configuration
   */
